...
if ($terms_sel) {
    ...
    if ($caf_all_ed == 'enable') {
        echo '<li class="caf-mb-4"><a href="#" data-id="' . esc_attr($trm1) . '" data-main-id="flt" class=" abc ' . esc_attr($cl) . '" data-target-div="data-target-div' . esc_attr($b) . '">Filter Events</a></li>';
    }
