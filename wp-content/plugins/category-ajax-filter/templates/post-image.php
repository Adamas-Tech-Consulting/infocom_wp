...
if (isset($image[0])) {
            echo "<a href='" . esc_url($link) . "' target='" . esc_attr($caf_link_target) . "' class='" . $a_class . "'><div class='caf-featured-img-box " . $img_box . "' style='background:url(" . get_field('add_conference_logo') . "
                    )'></div></a>";
        } else {
